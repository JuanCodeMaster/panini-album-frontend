...
# Non-fatal: si Xcode Cloud rechaza -resolvePackageDependencies (su entorno
# pasa -disableAutomaticPackageResolution), el Package.resolved commiteado
# en el repo basta para que Archive funcione.
